...
const values_1 = require("graphql/execution/values.js");
...
class QueryComplexity {
    constructor(context, options) {
        ...
        this.maxQueryNodes = (_a = options.maxQueryNodes) !== null && _a !== void 0 ? _a : 10000;
    ...
    nodeComplexity(node, typeDef, activeFragments = new Set()) {
        if (node.selectionSet && typeDef) {
            ...
            const selectionSetComplexities = node.selectionSet.selections.reduce((complexities, childNode) => {
                ...
                if (this.evaluatedNodes >= this.maxQueryNodes) {
                    throw new graphql_1.GraphQLError('Query exceeds the maximum allowed number of nodes.');
                }
                ...
                switch (childNode.kind) {
                    ...
                    case graphql_1.Kind.FRAGMENT_SPREAD: {
                        ...
                        const nodeComplexity = this.nodeComplexity(fragment, fragmentType, activeFragments);
                    ...
                    case graphql_1.Kind.INLINE_FRAGMENT: {
                        ...
                        const nodeComplexity = this.nodeComplexity(childNode, inlineFragmentType, activeFragments);
                    ...
                    default: {
                        innerComplexities = addComplexities(this.nodeComplexity(childNode, typeDef, activeFragments), complexities, possibleTypeNames);
                        break;
                    }
                }
